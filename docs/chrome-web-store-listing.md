...
It improves wide Markdown tables in file previews by keeping them readable inside a horizontal scroll container. It also adds compact controls for freezing displayed rows and columns, hiding rows or columns temporarily, and resizing columns while reviewing large tables.
...
- Uses a content script only and does not request extra Chrome extension permissions.
